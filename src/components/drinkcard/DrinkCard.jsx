        ...
        2xl:w-155">
            ...
            <div className="drink-card-body w-100 h-full flex flex-col">
                <div className="drink-card-header w-full h-[20%] flex items-center">
                    <h3 className="font-c-source text-md text-start pl-[8%] text-gold-4">{name}</h3>
                </div>
                <div className="seperator-container relative w-full h-[5%] bg-black ">
                ...
                <div className="drink-card-content h-[75%] w-full flex flex-col gap-[10%] pt-[4%] pl-[4%]">
                    <p className="ingredients font-c-source text-sm text-gold-4 pl-[4%] ">{ingredients}</p>
                    <p className="ingredients font-c-source text-sm text-gold-4 pl-[4%] ">{description}</p>
                </div>
            </div> 
        </div>
    );
